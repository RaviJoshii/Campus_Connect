...
public class MessageAdapter extends ArrayAdapter<MessageFormat> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(TextUtils.isEmpty(message.getMessage())){
            ...
            Log.i(group.TAG, "getView: is empty ");
            String userConnected = message.getUsername();
            messageText.setText(userConnected);

        }else if(message.getUniqueId().equals(group.uniqueId)){
            Log.i(group.TAG, "getView: " + message.getUniqueId() + " " + group.uniqueId);
            ...
            Log.i(group.TAG, "getView: is not empty");

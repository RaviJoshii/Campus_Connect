...
public class unotes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unotes);
    ...
    private void enable_button() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.e("first2","first2");
                Intent intent = new Intent(unotes.this, FilePickerActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent data) {
        editText=findViewById(R.id.desc2);
    ...
    public class SendPostRequestchange extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                URL url = new URL("http://192.168.43.212:7000/home/teacher/filesystem2"); // here is your URL path
